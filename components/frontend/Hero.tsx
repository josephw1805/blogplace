...
export function Hero() {
  return (
    <>
      <div className="relative flex flex-col w-full py-5 mx-auto md:flex-auto md:flex-row md:items-center md:justify-between">
        ...
        <div className="relative items-center w-full py-12 lg:py-20">
          <div className="text-center">
            <span className="text-sm text-primary font-medium tracking-tight bg-primary/10 px-4 py-2 rounded-full">
              Ultimate Blogging SasS for Starups
            </span>
          ...
          <div className="relative items-center w-full py-12 mx-auto mt-12">
            ...
            <Image
              src={HeroImage}
              alt="Hero image"
              className="relative object-cover w-full border rounded-lg shadow-2xl lg:rounded-2xl opacity-70"
              priority
            />
          </div>
        </div>
